...
#define  M8266WIFI_nRESET_GPIO											GPIOB
#define  M8266WIFI_nRESET_PIN												GPIO_Pin_1
...
#elif defined(MCU_IS_STM32F4XX)  // STM's STM32F4XX
//using *GPIOD3* as nCS
#define  M8266WIFI_SPI_nCS_GPIO_RCC_CLOCK_EN				RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE)
#define  M8266WIFI_SPI_nCS_GPIO											GPIOB
#define  M8266WIFI_SPI_nCS_PIN											GPIO_Pin_12                    //根据自己的需要，修改ncs
//using *GPIOA4* as nCS
//#define  M8266WIFI_SPI_nCS_GPIO_RCC_CLOCK_EN		  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA, ENABLE)
//#define  M8266WIFI_SPI_nCS_GPIO										GPIOA
//#define  M8266WIFI_SPI_nCS_PIN										GPIO_Pin_4
...
#define  M8266WIFI_SPI_INTERFACE_NO							2   // for STM32F4xx, try to use SPI1 other than SPI2 and SPI3, since according to datasheet, SPI1 has a better performance than SPI2 and SPI3
                                    //修改spi初始化的端口为2，由于硬件电路是这样的
//- If uses USART1, USART1_TXD=PA9, USART1_RXD=PA10
//- If uses USART2, USART2_TXD=PA2, USART2_RXD=PA3   
#define  M8266WIFI_USART_INTERFACE_NO						1 // 1 for USART1, 2 for USART2    如果没有usart3，如果后面用到了，自己再写一个
...
#define RCC_AHB1Periph_GPIO_LEDS								RCC_AHB1Periph_GPIOE
#define LED_GPIOS															  GPIOE
